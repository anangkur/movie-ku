...
import com.anangkur.movieku.databinding.ItemMainHorizontalLandscapeBinding
...
class TvAdapter(private val mainItemListener: MainItemListener): RecyclerView.Adapter<TvAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            ItemMainHorizontalLandscapeBinding.inflate(
    ...
    inner class ViewHolder(
        private val binding: ItemMainHorizontalLandscapeBinding
